...
dataset$list.main.temp = lapply(dataset$list.main.temp,convert_to_censius)
...
#cau2a
plot(dataset$list.dt,dataset$list.main.pressure,type="l",col="blue")
plot(dataset$list.dt,dataset$list.main.wind.speed,type="l",col="pink")
